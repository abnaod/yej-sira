...
function TableRow({ className, ...props }: React.ComponentProps<"tr">) {
  return (
    <tr
      data-slot="table-row"
      className={cn(
        "border-b transition-colors hover:bg-gray-100 has-aria-expanded:bg-gray-100 data-[state=selected]:bg-muted dark:hover:bg-gray-800 dark:has-aria-expanded:bg-gray-800",
        className
      )}
      {...props}
    />
