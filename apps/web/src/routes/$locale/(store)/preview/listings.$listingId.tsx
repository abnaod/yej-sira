...
import { SellerProductStorefrontPreviewPage } from "@/features/seller/products/product-storefront-preview.page";
...
export const Route = createFileRoute("/$locale/(store)/preview/products/$productId")({
  component: SellerProductStorefrontPreviewPage,
});
